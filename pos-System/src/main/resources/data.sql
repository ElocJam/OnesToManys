...
VALUES
    ('F7', 'Cole J.', CURRENT_TIMESTAMP, 4, 68.97, 2.06, 71.03, 'Birthday party - bring dessert at end'),
    ('B3', 'Antoinette R.', CURRENT_TIMESTAMP, 2, 35.99, 1.07, 37.06, 'Prefers sides out as app'),
    ('C12', 'Gabe L.', CURRENT_TIMESTAMP, 6, 75.98, 2.28, 78.26, 'Corporate lunch - bring check by 1pm'),
    ('P2', 'Dylan A.', CURRENT_TIMESTAMP, 3, 99.00, 2.97, 101.97, 'Chilled glasses for margs'),
    ('F11', 'Cole J.', CURRENT_TIMESTAMP, 1, 21.99, 0.66, 22.65, NULL);
